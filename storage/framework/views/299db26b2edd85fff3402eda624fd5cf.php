...
<table width="100%" style="border-collapse: collapse; font-family: 'Helvetica Neue', Arial, sans-serif;">
    ...
    <tr style="border: 1px solid #000; font-size: 9px;">
        <td style="padding: 4px; border: 1px solid #000; text-align: center;"><?php echo e($index + 1); ?></td>
        <td style="padding: 4px; border: 1px solid #000;"><?php echo e($row['description']); ?></td>
        ...
        <td style="padding: 4px; border: 1px solid #000; text-align: center;"><?php echo e($row['payment_reference']); ?></td>
...
<?php /**PATH /var/www/html/gruposamanez/api/resources/pdf/templates/reports/barbershop/income-per-day.blade.php ENDPATH**/ ?>