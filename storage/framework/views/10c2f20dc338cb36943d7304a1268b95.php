...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .enrollment-code { float: right; font-size: 10px; color: #888; }
    .text-muted { color: #888; font-size: 9px; }
</style>
<?php /**PATH /var/www/html/gruposamanez/api/resources/pdf/templates/enrollments/common/head.blade.php ENDPATH**/ ?>