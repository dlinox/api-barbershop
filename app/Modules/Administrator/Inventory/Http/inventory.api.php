...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-products')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-product-presentations')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-stocks')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-kardex')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-purchase-orders')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/inventory-sales')->group(function () {
    ...
    Route::get('/sales-overview/{cashSessionId}', [SaleController::class, 'salesOverview'])->name('inventory-sales.salesOverview');
});
