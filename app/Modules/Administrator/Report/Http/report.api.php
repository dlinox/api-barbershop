...
Route::middleware(['auth:api', 'super_admin'])->prefix('/report-academy')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/report-barbershop')->group(function () {
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/report-treasury')->group(function () {
    // Dashboard
...
Route::middleware(['auth:api', 'super_admin'])->prefix('/report-inventory')->group(function () {
    // Dashboard
