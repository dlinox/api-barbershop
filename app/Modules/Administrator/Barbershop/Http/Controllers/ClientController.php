...
use App\Modules\Administrator\Barbershop\Services\ClientService;
...
class ClientController
{
    ...
    {
        $item = $this->clientService->selectAsyncItems($request);
        $item = ClientSelectItemResource::collection($item);
        return ApiResponse::success($item);
    }
}
