...
class TeacherAttendanceRepository
{
    ...
    public function dataTable($request)
    {
        ...
        $query = GroupTeacher::select(
            ...
            'academy_group_teachers.teacher_id',
            'academy_group_teachers.group_id',
            'academy_group_teachers.hourly_rate',
            'academy_group_teachers.holiday_hourly_rate',
            'academy_group_teachers.status as assignment_status',

            'core_persons.id as teacher_person_id',
            'core_persons.name as teacher_name',
            ...
            'academy_levels.id as level_id',
            'academy_levels.name as level_name',

            'academy_schedules.id as schedule_id',
            ...
            'academy_teacher_attendances.check_token',
            'academy_teacher_attendances.check_type',
            'academy_teacher_attendances.status as attendance_status',
        ...
        if (empty($request->sortBy) || !isset($request->sortBy)) {
            $query->orderBy('academy_group_teachers.id', 'desc');
        }
