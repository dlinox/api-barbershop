...
class AttendanceRepository
{
    ...
    public function getGroupAttendanceWithDeadline(?string $date = null)
    {
        $date = $date ?? date('Y-m-d');
        return AttendanceDeadline::where('date', $date)->get();
    }

    public function getAttendanceDeadlineByGroup(int $groupId, ?string $date = null): ?AttendanceDeadline
    {
        $date = $date ?? date('Y-m-d');
        return AttendanceDeadline::where('group_id', $groupId)->where('date', $date)->first();
    }
}
