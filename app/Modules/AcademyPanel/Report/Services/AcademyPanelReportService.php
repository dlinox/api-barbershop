...
namespace App\Modules\AcademyPanel\Report\Services;
...
class AcademyPanelReportService
{
    ...
    public function generateIncomePerDayPdf(Request $request, int $branchId): Report
    {
