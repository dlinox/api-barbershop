...
<div class="section-label mt-8">Datos del Trabajador</div>

<table class="info-row">
    <tr>
        <td class="info-label">Nombre</td>
        <td class="info-value">{{ $worker?->person?->full_name ?? '—' }}</td>
    </tr>
</table>
<table class="info-row">
    <tr>
        ...
        <td class="info-value">
            {{ $worker?->person?->document_type ? strtoupper($worker->person->document_type) . ': ' : '' }}{{ $worker?->person?->document_number ?? '—' }}
        </td>
    </tr>
</table>
<table class="info-row">
    <tr>
        ...
        <td class="info-value">{{ $worker?->position ?? '—' }}</td>
    </tr>
</table>
<table class="info-row">
    <tr>
        <td class="info-label">Sede</td>
        <td class="info-value">{{ $infrastructure?->name ?? '—' }}</td>
    </tr>
</table>
...
<table class="summary-table">
    ...
    <tbody>
        <tr>
            <td class="label-cell">Sueldo Base</td>
