...
<table width="100%" style="border-collapse: collapse; font-family: 'Helvetica Neue', Arial, sans-serif; margin-top: 8px;">
    <tr style="border: 1px solid #000; font-size: 9px; font-weight: bold; text-align: center;">
        ...
        <th style="padding: 4px; border: 1px solid #000; width: 20%;">PRODUCTO</th>
        ...
        <th style="padding: 4px; border: 1px solid #000; width: 10%;">VALOR STOCK</th>
    </tr>
    ...
    <tr style="border: 1px solid #000; font-size: 9px;">
        ...
        <td style="padding: 4px; border: 1px solid #000; text-align: center; font-weight: bold; {{ $row['stock'] < $row['min_stock'] ? 'color: #cc0000;' : '' }}">{{ $row['stock'] }}</td>
    ...
    <tr style="font-size: 10px; font-weight: bold;">
        <td colspan="8" style="padding: 4px; border: 1px solid #000; text-align: right; background-color: #ffe598;">VALOR TOTAL INVENTARIO:</td>
