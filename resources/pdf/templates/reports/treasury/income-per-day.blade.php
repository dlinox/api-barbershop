...
<table width="100%" style="border-collapse: collapse; font-family: 'Helvetica Neue', Arial, sans-serif; margin-top: 8px;">
    <tr style="border: 1px solid #000; background-color: #ffe598;">
        <th style="text-align: left !important; padding: 4px;">B. DETALLE DE INGRESOS</th>
    </tr>
</table>
...
<table width="100%" style="border-collapse: collapse; font-family: 'Helvetica Neue', Arial, sans-serif;">
    <tr style="border: 1px solid #000; font-size: 9px; font-weight: bold; text-align: center;">
        ...
        <th style="padding: 4px; border: 1px solid #000; width: 12%;">COMPROBANTE</th>
        <th style="padding: 4px; border: 1px solid #000; width: 12%;">SERIE-NÚMERO</th>
        <th style="padding: 4px; border: 1px solid #000; width: 12%;">MEDIO PAGO</th>
        <th style="padding: 4px; border: 1px solid #000; width: 14%;">N° OPERACIÓN</th>
    ...
    @endforeach
    @for($i = count($rows) + 1; $i <= max(15, count($rows)); $i++)
    <tr style="border: 1px solid #000; font-size: 9px;">
    ...
    <tr style="font-size: 9px; font-weight: bold;">
        ...
        <td rowspan="2" style="padding: 4px; border: 1px solid #000; text-align: right; background-color: #ffe598; vertical-align: middle; font-size: 14px;">TOTAL DÍA:</td>
        <td rowspan="2" style="padding: 4px; border: 1px solid #000; text-align: right; background-color: #ffe598; vertical-align: middle; font-size: 14px;">S/ {{ number_format($total_day, 2) }}</td>
    </tr>
    <tr style="font-size: 9px; font-weight: bold;">
        <td style="border: none;"></td>
