...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value" colspan="3">{{ $position }}</td>
        </tr>
        <tr>
            <td class="label">Salario Mensual</td>
            <td class="value">{{ $monthly_salary ? 'S/ ' . number_format($monthly_salary, 2) : '—' }}</td>
            <td class="label">Frecuencia de Pago</td>
            <td class="value">{{ $payment_frequency }}</td>
        </tr>
        <tr>
    ...
    <table class="signatures">
        <tr>
            <td>
                <span class="line">Firma del Trabajador</span>
            </td>
            <td>
